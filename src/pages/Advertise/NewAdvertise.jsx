...
export default function NewAdvertise() {
  ...
  return (
    <div className="flex-1 p-4 w-full  min-h-screen">
      ...
      <h1 className="text-base md:text-2xl font-semibold text-secondary mb-6">New Advertise Information</h1>
      <Card className={cn("p-6 rounded-lg")}>
        <form onSubmit={handleSubmit}>
          <div className="grid gap-6 mb-6">
            <div className="flex justify-between items-center">
              <label htmlFor="serialNumber" className="text-sm md:text-base font-medium text-gray-700">
                Serial Number
              </label>
              <span className="text-sm md:text-base text-gray-600">{serialNumber}</span>
            </div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            <div className="md:col-span-3">
              <label htmlFor="title" className="text-sm md:text-base text-gray-700 font-medium block mb-2">
                Title
              </label>
              <input
                id="title"
            ...
            <div>
              <label htmlFor="category" className="text-sm md:text-base text-primary font-medium block mb-2">
                Category
              </label>
              <Select value={category} onValueChange={setCategory}>
                ...
                <SelectContent className="bg-white border border-gray-200 rounded shadow-lg">
                  <SelectItem value="news" className="text-sm md:text-base px-4  hover:bg-gray-100">
                    News
                  </SelectItem>
                  <SelectItem value="event" className="text-sm md:text-base px-4  hover:bg-gray-100">
                    Event
                  </SelectItem>
                  <SelectItem value="promotion" className="text-sm md:text-base px-4  hover:bg-gray-100">
                    Promotion
                  </SelectItem>
                  <SelectItem value="announcement" className="text-sm md:text-base px-4  hover:bg-gray-100">
                    Announcement
                  </SelectItem>
                </SelectContent>
              </Select>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div>
              <label htmlFor="photo" className="text-sm md:text-base text-gray-700 font-medium block mb-2">
                Upload Photo
              </label>
              <FileUploader onFileChange={setFile} selectedFile={file} />
            </div>
            <div className="md:col-span-2">
              <label htmlFor="description" className="text-sm md:text-base text-gray-700 font-medium block mb-2">
                Description
              </label>
              <Textarea
                id="description"
